...
from speech_services import AzureSpeechSynthesizer
from htmlTemplate import css, other_user_template, user_template, audio_animation
    ...
    while video_running:
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                # Synthesize speech from the predicted character
                #synthesizer.synthesize_text(predicted_character)
